/*
 * 文件位置：arch/arm/mach-sunxi/sun8i.c
 *
 * @！！此文件已经被修改！！
 * 
 * sun8i platform file
 ...
 * 3.4 将按键的平台设备注册到内核中
 *
 * 文件功能： 此文件属于板级支持包(BSP),关于平台的定义可以放在这个文件，
 *	      如按键的结构体定义；spi的结构体定义等
 */
...
//#defined by Sun jack 2016.09.21
...
static struct gpio_keys_button gpio_buttons[] = {
	{
		.gpio			= GPIOL(11),
		.code			= KEY_5, //这个宏定义在include/linux/input.h文件
		.desc			= "KEY5",
		.active_low		= 1,
		.debounce_interval	= 5,
		.type			= EV_KEY,
